...
public class VideoTextureView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, "onMeasure:--> parentWidth:" + parentWidth + ",parentHeight:" + parentHeight + ",videoWidth:" + videoWidth + ",videoHeight:" + videoHeight);
...
//            Log.d(TAG, "onMeasure: widthSpecMode:" + widthSpecMode + ",heightSpecMode:" + heightSpecMode + "; " + MeasureSpec.EXACTLY + ": " + MeasureSpec.AT_MOST);
