package com.yc.emotion.home.model.constant;
...
//    public static final String WX_APP_ID = "wx1fe84de893008f11"; //微信使用    //2018-11-13
    ...
    public static final String TAG_POSTION = "tag_position";

    @NotNull
    public static final String PhHONE = "phone";
    @NotNull
    public static final String IS_FIRST_GUIDE = "is_first_guide"; //是否是首次显示引导页
    @NotNull
