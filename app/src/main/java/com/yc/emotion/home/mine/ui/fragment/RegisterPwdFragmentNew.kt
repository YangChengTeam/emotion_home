 ...
 */
class RegisterPwdFragmentNew : BaseRegisterPhoneFragment() {
    ...
    companion object {
        fun newInstance(phone: String?, code: String): RegisterPwdFragmentNew {
            val registerPwdFragment = RegisterPwdFragmentNew()
