 ...
 */
class RewardMoneyAdapter(datas: List<RewardDetailInfo>?) : BaseQuickImproAdapter<RewardDetailInfo, BaseViewHolder>(R.layout.item_reward_money, datas) {
    override fun convert(helper: BaseViewHolder, item: RewardDetailInfo?) {
        item?.let {
            helper.setText(R.id.tv_reward_name, it.nick_name)
                    ...
                    .setText(R.id.tv_reward_content, "成功提现${it.money}元现金")
