 ...
 */
class TutorServiceCommentDetailAdapter(mDatas: List<CommunityInfo>?) : BaseQuickAdapter<CommunityInfo, BaseViewHolder>(R.layout.tutor_service_comment_detail_item, mDatas) {
